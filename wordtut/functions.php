...
function websiteQueryVars($vars) {
    $vars[] = 'skyColor';
    return $vars;
}
add_filter('query_vars', 'websiteQueryVars');
...
function website_files(){
    wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=AIzaSyBqR1eVJEqNb55WT0S_az06y5idtif8KzA', NULL, '1.0', true);
    ...
    wp_enqueue_style('website_styles', get_stylesheet_uri(), NULL, microtime());
    wp_localize_script('main_js_file', 'websiteData', array(
...
function universityMapKey($api) {
    $api['key'] = 'AIzaSyBqR1eVJEqNb55WT0S_az06y5idtif8KzA';
    return $api;
}
