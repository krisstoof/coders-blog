    ...
    <header class="site-header">
        <div class="container">
            ...
            <div class="site-header__menu group">
                ...
                ?>
                        <ul>
                            <li <?php if(is_page('about-us') or wp_get_post_parent_id(0) == 20) echo 'class="current-menu-item"'; ?>>
                                <a href="<?php echo site_url('/about-us'); ?>">O nas</a>
                            </li>
                            <li <?php if(get_post_type() == 'program') echo 'class="current-menu-item"'; ?>>
                                <a href="<?php echo get_post_type_archive_link('program'); ?>">Kategorie</a>
                            </li>
                            <li <?php if(get_post_type() == 'event' OR is_page('past-events')) echo 'class="current-menu-item"'; ?>>
                                <a href="<?php echo site_url('/events'); ?>">Wydarzenia</a>
                            </li>
                            <li <?php if(get_post_type() == 'campus') echo 'class="current-menu-item"'; ?>>
                                <a href="<?php echo get_post_type_archive_link('campus') ?>">Lokalizacje</a>
                            </li>
                ...
                <?php
                    if(is_user_logged_in()) { ?>
                        ...
                        <a href="<?php echo wp_logout_url(); ?>" class="btn btn--small btn--with-photo btn--dark-orange float-left">
