...
function () {
  ...
  _createClass(Search, [{
    ...
    value: function getResults() {
      ...
      _jquery.default.getJSON(websiteData.root_url + '/wp-json/website/search?term=' + this.searchField.val(), function (results) {
        _this.resultsDiv.html("\n                <div class=\"row\">\n                    <div class=\"one-third\">\n                        <h2 class=\"search-overlay__section-title\">General Information</h2>\n                        ".concat(results.generalInfo.length ? '<ul class="link-list min-list">' : '<p>No general information matches that search.</p>', "\n                            ").concat(results.generalInfo.map(function (item) {
        ...
        }).join(''), "\n                        ").concat(results.generalInfo.length ? '</ul>' : '', "\n                    </div>\n                    <div class=\"one-third\">\n                        <h2 class=\"search-overlay__section-title\">Programs</h2>\n                            ").concat(results.programs.length ? '<ul class="link-list min-list">' : "<p>No programs information match that search. <a href=\"".concat(websiteData.root_url, "/programs\">View all programs.</a></p>"), "\n                                ").concat(results.programs.map(function (item) {
          ...
          return "\n                                    <li class=\"professor-card__list-item\">\n                                        <a class=\"professor-card\" href=\"".concat(item.permalink, "\">\n                                            <img src=\"").concat(item.image, "\" alt=\"").concat(item.title, "\" class=\"professor-card__image\">  \n                                            <span class=\"professor-card__name\">").concat(item.title, "</span>\n                                        </a>\n                                    </li>\n                                ");
        }).join(''), "\n                            ").concat(results.professors.length ? '</ul>' : '', "\n                    </div>\n                    <div class=\"one-third\">\n                        <h2 class=\"search-overlay__section-title\">Campuses</h2>\n                            ").concat(results.campuses.length ? '<ul class="link-list min-list">' : "<p>No campuses match that search. <a href=\"".concat(websiteData.root_url, "/campuses\">View all campuses.</a></p>"), "\n                                ").concat(results.campuses.map(function (item) {
          return "<li><a href=\"".concat(item.permalink, "\">").concat(item.title, "</a></li>");
        }).join(''), "\n                            ").concat(results.campuses.length ? '</ul>' : '', "\n                        <h2 class=\"search-overlay__section-title\">Events</h2>\n                            ").concat(results.events.length ? '' : "<p>No events match that search. <a href=\"".concat(websiteData.root_url, "/events\">View all events.</a></p>"), "\n                                ").concat(results.events.map(function (item) {
    ...
    value: function openOverlay() {
      ...
      console.log("open method just run");
    ...
    value: function closeOverlay() {
      ...
      console.log("close method just run");
      this.isOverlayOpen = false;
    }
  }, {
    key: "addSearchHTML",
...
function () {
  ...
  _createClass(MyNotes, [{
    ...
    value: function events() {
      ...
      (0, _jquery.default)("#my-notes").on("click", ".edit-note", this.editeNote.bind(this));
    ...
    value: function deleteNote(e) {
      ...
      _jquery.default.ajax({
        ...
        url: websiteData.root_url + '/wp-json/wp/v2/note/' + thisNote.data('id'),
        type: 'DELETE',
    ...
    value: function createNote(e) {
      ...
      _jquery.default.ajax({
        ...
        url: websiteData.root_url + '/wp-json/wp/v2/note/',
        type: 'POST',
        data: ourNewPost,
        success: function success(response) {
  ...
  _createClass(Like, [{
    ...
    value: function createLike(currentLikeBox) {
      _jquery.default.ajax({
        ...
        url: websiteData.root_url + '/wp-json/website/v1/manageLike',
        type: 'POST',
        data: {
